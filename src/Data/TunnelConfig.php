...
YAML);
    ...
    {
        return $this->assemble(\PixoVoid\Cloudflared\Support\Platform::homeDirectory(), '.cloudflared', "{$this->id()}.yaml");
    }

    public function credentialsPath(): string
    {
        return $this->assemble(\PixoVoid\Cloudflared\Support\Platform::homeDirectory(), '.cloudflared', "{$this->id()}.json");
    }
}
